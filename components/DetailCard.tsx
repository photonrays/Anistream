                ...
                <CardBody className="p-2 justify-center">
                    <div className="grid grid-cols-[50px_1fr] items-center justify-center overflow-hidden">
                        ...
                        <div className="ml-3">
                            ...
                            <p className='text-text-white line-clamp-2 mb-1'>{typeof anime.title === 'string' ? anime.title : anime.title.english}</p>
                            <div className="flex items-center gap-1 justify-between">
                                <div className='flex items-center gap-1'>
                                    {anime.episodes && <Chip startContent={<Icon icon="bi:badge-cc-fill" className="text-lg mr-1" />} color="primary" size="sm" radius="sm" className="pl-2 h-[21px]">{anime.episodes as unknown as string}</Chip>}
                                    {anime.sub && <Chip color="default" size="sm" radius="sm" className='h-[21px]'>{anime.sub}</Chip>}
                                </div>
