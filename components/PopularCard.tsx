    ...
    return (
        <div className="relative flex gap-4 justify-between w-full min-h-[250px] sm:max-h-[400px] lg:max-h-[400px] mb-4 bg-black px-[2px]">
            <div className="hidden lg:block my-auto max-w-[40%] pl-4">
                <p className="font-bold mb-2 lg:text-5xl line-clamp-3">{typeof anime.title === 'string' ? anime.title : anime.title.english}</p>
            ...
            <img src={anime.cover} alt="NextUI hero Image" className="object-cover flex-1 w-full h-[400px] lg:min-w-[60%] rounded-none lg:rounded-lg" />
