...
export default async function Home() {
  const [animeHome, topAiring, latestCompleted] = await Promise.all([getAnimeHomePage(), getAnimeByCategory('top-airing'), getAnimeByCategory('completed')])
      ...
      <div className="w-full grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-5">
        <div className="w-full">
          <Suspense fallback={<RecentAnimeLoading />}>
            <RecentAnime animes={animeHome?.latestEpisodeAnimes} />
          </Suspense>
